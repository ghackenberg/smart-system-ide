...
public class ControlComponent extends org.xtream.demo.hydro.model.split.ControlComponent
{
	...
	public Expression<Double> hauptkraftwerkDischargeExpression = new DischargeExpression(hauptkraftwerkDischargeOutput, Constants.HAUPTKRAFTWERK_DISCHARGE_MAX, speicherseeLevelInput, Constants.SPEICHERSEE_AREA, Constants.SPEICHERSEE_LEVEL_MAX, scenarioInflowInput);
