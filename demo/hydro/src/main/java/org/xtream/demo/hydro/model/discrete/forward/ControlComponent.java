...
public class ControlComponent extends org.xtream.demo.hydro.model.discrete.ControlComponent
{
	...
	public Expression<Double> hauptkraftwerkTurbineDischargeExpression = new TurbineDischargeExpression(hauptkraftwerkTurbineDischargeOutput, hauptkraftwerkTurbineDischargeOptions, speicherseeLevelInput, Constants.SPEICHERSEE_AREA, Constants.SPEICHERSEE_LEVEL_MAX, scenarioInflowInput, dummyInflowInput);
