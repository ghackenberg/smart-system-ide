...
public class ControlComponent extends org.xtream.demo.hydro.model.control.split.continuous.ControlComponent
{
	...
	public Expression<Double> hauptkraftwerkTurbineDischargeExpression = new TurbineDischargeExpression(hauptkraftwerkTurbineDischargeOutput, Constants.HAUPTKRAFTWERK_TURBINE_DISCHARGE_MAX, speicherseeLevelInput, Constants.SPEICHERSEE_AREA, Constants.SPEICHERSEE_LEVEL_MAX, inflowInput, dummyInflowInput);
