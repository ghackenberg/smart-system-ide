...
Based on the parameters $Power\_Scale$ and $Profile$ static load components output a predefined energy profile for any given time. Both parameters allow one to vary static (i.e.\ non-controllable) load in different scenarios easily.
