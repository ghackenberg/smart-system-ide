...
In contrast, approaches for \textit{vehicle routing} describe optimizing route selection for traffic participants and focus on control strategies for route selection/driving.
...
Then, in the field of \textit{modeling and simulation}, Galus et al. \cite{galus2012integrating} combine power system models, agent based transport simulations and modeling to investigate the impact of electric mobility on integrated transportation and power systems.
Finally, Junaibi et al. \cite{al2013method} assess the technical feasibility of EV penetration within integrated systems by microscopically modeling traffic and power flows and ITS.
